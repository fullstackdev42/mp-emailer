...
func (_m *MockServiceInterface) AuthenticateUser(ctx context.Context, username string, password string) (*user.User, error) {
...
func (_c *MockServiceInterface_AuthenticateUser_Call) Return(_a0 *user.User, _a1 error) *MockServiceInterface_AuthenticateUser_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockServiceInterface_AuthenticateUser_Call) RunAndReturn(run func(context.Context, string, string) (*user.User, error)) *MockServiceInterface_AuthenticateUser_Call {
	_c.Call.Return(run)
	return _c
}
