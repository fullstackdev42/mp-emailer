...
func (_m *MockRepository) GetUserByUsername(username string) (*user.User, error) {
...
func (_c *MockRepository_GetUserByUsername_Call) Return(_a0 *user.User, _a1 error) *MockRepository_GetUserByUsername_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRepository_GetUserByUsername_Call) RunAndReturn(run func(string) (*user.User, error)) *MockRepository_GetUserByUsername_Call {
	_c.Call.Return(run)
	return _c
}
