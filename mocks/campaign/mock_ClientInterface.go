...
func (_m *MockClientInterface) FetchRepresentatives(postalCode string) ([]Representative, error) {
...
func (_c *MockClientInterface_FetchRepresentatives_Call) Return(_a0 []Representative, _a1 error) *MockClientInterface_FetchRepresentatives_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClientInterface_FetchRepresentatives_Call) RunAndReturn(run func(string) ([]Representative, error)) *MockClientInterface_FetchRepresentatives_Call {
	_c.Call.Return(run)
	return _c
}
