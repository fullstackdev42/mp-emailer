...
// ComposeEmail provides a mock function with given fields: mp, campaign, userData
func (_m *MockServiceInterface) ComposeEmail(mp Representative, campaign *Campaign, userData map[string]string) string {
	ret := _m.Called(mp, campaign, userData)
...
func (_e *MockServiceInterface_Expecter) ComposeEmail(mp interface{}, campaign interface{}, userData interface{}) *MockServiceInterface_ComposeEmail_Call {
	return &MockServiceInterface_ComposeEmail_Call{Call: _e.mock.On("ComposeEmail", mp, campaign, userData)}
}

func (_c *MockServiceInterface_ComposeEmail_Call) Run(run func(mp Representative, campaign *Campaign, userData map[string]string)) *MockServiceInterface_ComposeEmail_Call {
...
// CreateCampaign provides a mock function with given fields: campaign
func (_m *MockServiceInterface) CreateCampaign(campaign *Campaign) error {
...
//   - campaign *Campaign
func (_e *MockServiceInterface_Expecter) CreateCampaign(campaign interface{}) *MockServiceInterface_CreateCampaign_Call {
	return &MockServiceInterface_CreateCampaign_Call{Call: _e.mock.On("CreateCampaign", campaign)}
}

func (_c *MockServiceInterface_CreateCampaign_Call) Run(run func(campaign *Campaign)) *MockServiceInterface_CreateCampaign_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*Campaign))
	})
	return _c
...
func (_m *MockServiceInterface) UpdateCampaign(campaign *Campaign) error {
	ret := _m.Called(campaign)
...
//   - campaign *Campaign
func (_e *MockServiceInterface_Expecter) UpdateCampaign(campaign interface{}) *MockServiceInterface_UpdateCampaign_Call {
	return &MockServiceInterface_UpdateCampaign_Call{Call: _e.mock.On("UpdateCampaign", campaign)}
}

func (_c *MockServiceInterface_UpdateCampaign_Call) Run(run func(campaign *Campaign)) *MockServiceInterface_UpdateCampaign_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*Campaign))
	})
	return _c
